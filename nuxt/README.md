...
2. Basic example how to init LiveSession script in the `plugins/livesession.ts` file.

2. Basic example how to use [custom events](https://help.livesession.io/en/articles/8496404-custom-events)
   in the `components/Counter.vue` file (the `Counter` event name).
