...
2. `NEXT_PUBLIC_LIVESESSION_TRACK_ID` environment variable - you can add it to the `.env` file.
...
2. Basic example how to use [custom events](https://help.livesession.io/en/articles/8496404-custom-events)
   in the `src/app/components/Counter.tsx` file (the `Counter` event name).
